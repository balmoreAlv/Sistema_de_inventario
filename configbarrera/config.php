  ...
  <div class="form-panel">
    <div class="container-fluid">
      ...
      <form method="POST" action="ajax/editar_perfil.php">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><i class='glyphicon glyphicon-cog'></i> Configuración de El Sistema de Inventario y Facturaci&oacute;n</h3>
            </div>
        ...
        <div id="load_img">
          <img class="img-responsive" src="../imagenes/uls.jpg" id="imga">
        </div>
...
<br><br><br><br><br><br>
        ...
        <div id="loadd_img">
          <img class="img-responsive"  src="../imagenes/uls.jpg" id="imgaa">
        </div>
                  ...
                  <table class="table table-condensed">
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" class="form-control input-sm" name="nombre_empresa" value="<?php echo $nombre_empresa ?>" required></td>
                      </tr>
                      <tr>
                        <td>Teléfono:</td>
