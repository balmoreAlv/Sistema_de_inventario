...
//consult para seleccionar todos los datos de la compra
 ...
 $command = "SELECT detallecompra.cantidad,producto.nombre as nombrepr,producto.descripcion as descrip, detallecompra.precio,detallecompra.subtotal, compra.fechacompra FROM detallecompra inner join producto 
 on detallecompra.idproducto = producto.idproducto INNER JOIN compra on detallecompra.idcompra = compra.idcompra WHERE idcompra = '$id'";
...
$proveedor = $data['nombrecontacto']; 
$dat = date('d-m-y');

$proveedorfecha =$proveedor." ".$dat;
...
<table border="0" width="100%" align="center" cellpading="0" cellspacing="0" style="" >
        <tbody><tr>
          ...
          <td align="center" width="60%" style=""><br><br><br><h2>Factura de compra</h2><br></td>
          <td a width="30%" style="text-align: right;">No.<br /><span style="font-weight: bold; font-size: 12pt;">0'.$data['idcompra'].'</span></td>
        </tr>
      </tbody></table>
</htmlpageheader>
...
<td width="10%">&nbsp;</td>
<td width="45%" style="border: 0.1mm solid #888888; ">RESPONSABLE COMPRA:<br /><u>'.$nombres.'</u><br /><br />
FECHA DE COMPRA: <span style="border-bottom:1px solid black" align="left">'.$data['fechacompra'].'</span>
</td>
</tr></table>
...
<td class="totals" style="text-align:left;" colspan="2">TOTAL (LETRAS) <b>'.numtoletras($totaldiner) .'</b></td>
