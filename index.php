...
<!-- Icono que aparece en la ventana del navegador -->
  <link rel="shortcut icon" href="data:image/jpg;base64,<?php echo base64_encode(favicon); ?>"/>
...
<!--  Formularioo del login para poder ingresaar al sistema-->
        <form id="log" action="./recuperar/enviar.php" accept-charset="utf-8"  name="loginform" autocomplete="off" role="form"  method="POST" >
            <div id="loginarea">
                ...
                <center><h6><font color="black">INICIO DE SESI&Oacute;N</font></h6></center>
                      ...
                      echo"<meta http-equiv='refresh' content='3; url=http://localhost/barrera/index.php'/ >";
                    }
    ...
    ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <!-- Imagen q se muestar en el login -->
                            <img src="imagenes/login.png" class="img-responsive img-rounded" />
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <!--Boton submit del formulario del login  -->
                         <button type="submit" class="btn btn-success" name="accion"><span class="glyphicon glyphicon-log-in"></span>  ENTRAR</button>
                    </div>
                </div>
                <hr/>
                ...
                <!-- Linkk para poder recuperar la contraseña del usuario -->
                   <!--<center><a href="recuperar/password.php"><i class="glyphicon glyphicon-question-sign"></i>&nbsp;&nbsp;¿Olvidaste tu contrase&ntilde;a?</a><br><br></center>-->
                     <!-- Derechos reservados del creador --><center><strong>Copyright &copy; 2019 <font color="black"> Sistema de Inventario Y Facturaci&oacute;n</font></strong></center>
