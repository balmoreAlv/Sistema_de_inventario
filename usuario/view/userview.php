...
//si se cumple a condicion
    ...
    //addslashes(str) para no permitir sqlinjection
		 ...
		 $aColumns = array('idusuario','nombre','apellido','email','estado','nombretipo');//Columnas de busqueda
		 $sTable = "ver_usuario"; // nombre de la tabla
...
$sql = "SELECT * FROM $sTable $sWhere ORDER BY idusuario desc LIMIT $offset,$per_page";
