...
//Condicion para verifcarsi se cumple
	if($action == 'ajax'){
		...
		//addcslashes(str, charlist) para no permitir el sql injection
		 ...
		 $aColumns = array('idtipousuario','nombre');//Columnas de busqueda de aacuerdo a la base de datos
		 $sTable = "ver_tipousuario"; // nombre de la tabla
...
<li><a  style='cursor:pointer;' data-toggle='modal' data-target='#modal_update' data-placement='bottom' title='Editar Registro' onclick='editartipo(".$row['idtipousuario'].");''><i class='fa fa-edit'></i> Editar</a></li><li><a  style='cursor:pointer;' href='editarpermisos.php?idprivilegio=".$row['idtipousuario']."'><i class='fa fa-user'></i> Editar Permisos</a></li>";
