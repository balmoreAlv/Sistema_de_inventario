...
<label for="tax_number" class="col-sm-3 control-label">Nombre contacto:</label>
<div class="col-sm-9">
<input type="text" style="text-transform:Lowercase;"  onkeyup =onkeyup ="javascript:this.value=this.value.toLowerCase();"    id="mod_nombredit" name="mod_nombredit"placeholder="Ingrese el nombre del contacto es obligatorio" class="form-control">
</div>
</div>
...
<label for="tax_number" class="col-sm-3 control-label">Tel&eacute;fono Contacto:</label>
<div class="col-sm-9">
 <input type="text" pattern="^[7|2|6]\d{3}-?\d{4}$"  onkeypress="return justNumbers(event);" id="mod_telecedit" name="mod_telecedit"placeholder="Ingrese número del contacto es obligatorio" class="form-control">
</div>
</div>
