...
//si se cumple a condicion
    ...
    //addslashes(str) para no permitir sqlinjection
		 ...
		 $aColumns = array('idproducto','nombre','descripcion','fechav','nombretipo','estado');//Columnas de busqueda
		 $sTable = "ver_producto"; // nombre de la tabla,
...
$count_query = "SELECT * FROM $sTable $sWhere  order by idproducto desc";
//Ejecuta el query
...
$sql = "SELECT * FROM $sTable $sWhere order by idproducto desc LIMIT $offset,$per_page";
...
<tr class="danger"> <td></td><td></td ><td>Totales por P&aacute;gina:</td>
 ...
 <td><span class="badge label-primary"><li class='glyphicon glyphicon-usd '></li> <?php echo number_format($precioun,2); ?></span></td>
