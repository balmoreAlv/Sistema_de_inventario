        ...
        <div class="card card-container">
            ...
            <?php
            	...
            	if (!empty($_GET['desbloquear'])) {
            		...
            		echo"<meta http-equiv='refresh' content='3; url=http://localhost/cerritopanoramico/index.php'/ >";
...
<font color ="black" ><label>E-mail:</label></font><input type="email" name="email" class="form-control" placeholder="Ingrese su correo Electrónico" required>
	...
	<a href="../index.php" class="btn btn-success"><span class="fa fa-user"> </span>  Inicio Sesión</a>
...
$cod = addslashes($_POST['code']);
	...
	$qg = $conn->prepare("SELECT * FROM usuario where email = '$email'");
			...
			if ($email == $us) {
				...
				echo "<br><p class='alert alert-success'>Excelente. Código: ".$cod." y E-mail son correctos!</p>";
