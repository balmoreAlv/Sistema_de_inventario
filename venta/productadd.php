...
<div class='alert alert-info alert-dismissable'>
  ...
  $que = "SELECT detalleventa.*,producto.nombre as nombrepr,producto.preciounitario FROM detalleventa inner join producto
  on detalleventa.idproducto = producto.idproducto WHERE idventa = $idventa";
  $res = $conn->query($que);
  $filas = $res->fetchAll();
  $todo = count($filas);
