...
if (!empty($_GET['id'])) {
    ...
    $sql = "SELECT venta.*,cliente.* FROM venta  inner join cliente on venta.idcliente= cliente.idcliente where idventa = '$id'";
    $q = $conn->prepare($sql);
...
<!-- formulario de registro de Cliente -->
 		...
 		<div class="row">
 			<div class="col-md-6">
				<div>Cliente:<input type="text" value="<?php echo $nombreapellido;?>" name="nombre" id="nombre" class="form-control"></div>
					</div>


			<div class="col-md-6">	

			<input type="hidden" name="idorden" value="<?php echo $idd;?>" id="idorden">
				<div>Producto:
