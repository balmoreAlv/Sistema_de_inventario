...
<div class='alert alert-info alert-dismissable'>
  ...
  $que = "SELECT detallecompra.*,producto.nombre as nombrepr,producto.preciounitario FROM detallecompra inner join productocompra on detallecompra.idproductocompra = producto.idproducto WHERE idcompra = $idcompra";
  $res = $conn->query($que);
  $filas = $res->fetchAll();
  $todo = count($filas);
