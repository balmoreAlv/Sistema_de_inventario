...
<html oncontextmenu="return false">
  <head>
    ...
    <meta name="keyword" ><link rel="shortcut icon" href="data:image/jpg;base64,<?php echo base64_encode(favicon); ?>"/>

   <title>Sistema de inventario Variedades Barreras<</title>
   ...
   function login(){
                //un prompt
                alertify.prompt(" <img src='./img/warning.png'><b><h3>Ingresa nombre secreto:</h3></b>", function (e, str) { 
                    if (e){

                        if (str=="Barrera") {
                        alertify.success("Excelente " + str + ", </h5> puedes continuar!");
                        setTimeout('location.href="./"', 3000);

                    }else{
                        alertify.error("Debes ingresar el nombre secreto");
                        return false;
                    }
                    }else{
  ...
  <body onload="getTime()">
    ...
    <script>
        $.backstretch("recuperar/libscreen/img/cerr.jpg", {speed: 500});
