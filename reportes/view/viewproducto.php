...
//si se cumple a condicion
    ...
    //addslashes(str) para no permitir sqlinjection
		 ...
		 $aColumns = array('idproducto','producto.nombre','producto.descripcion','producto.fechav','tipoproducto.nombre','producto.estado');//Columnas de busqueda
...
$count_query = "SELECT producto.*,tipoproducto.nombre as nombproducto, tipoproducto.idtipoproducto as idtipo FROM $sTable
   INNER JOIN tipoproducto ON producto.idtipoproductos = tipoproducto.idtipoproducto $sWhere  order by producto.idproducto desc";
//Ejecuta el query
